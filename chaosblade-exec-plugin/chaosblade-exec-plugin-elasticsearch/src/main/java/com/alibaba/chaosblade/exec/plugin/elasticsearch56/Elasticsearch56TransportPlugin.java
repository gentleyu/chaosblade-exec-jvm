 ...
 * @author yuqibin
 */
public class Elasticsearch56TransportPlugin extends AbstractElasticsearchTransportPlugin {
    ...
    public PointCut getPointCut() {
        return new Elaticsearch56TransportPointCut();
    }

    @Override
    public Enhancer getEnhancer() {
        return new Elasticsearch56TransportEnhancer();
    }
}
